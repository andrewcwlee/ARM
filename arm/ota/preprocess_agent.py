...
class PreprocessAgent(Agent):
    ...
    def update_summaries(self) -> List[Summary]:
        ...
        sums = [
            ...
            HistogramSummary('%s/low_dim_state_layer0' % prefix,
                    self._replay_sample['low_dim_state_layer_0']),
            HistogramSummary('%s/low_dim_state_layer0_tp1' % prefix,
                    self._replay_sample['low_dim_state_layer_0_tp1']),
            HistogramSummary('%s/low_dim_state_layer1' % prefix,
                    self._replay_sample['low_dim_state_layer_1']),
            HistogramSummary('%s/low_dim_state_layer1_tp1' % prefix,
                    self._replay_sample['low_dim_state_layer_1_tp1']),
            
            ScalarSummary('%s/low_dim_state_mean_layer0' % prefix,
                    self._replay_sample['low_dim_state_layer_0'].mean()),
            ScalarSummary('%s/low_dim_state_min_layer0' % prefix,
                    self._replay_sample['low_dim_state_layer_0'].min()),
            ScalarSummary('%s/low_dim_state_max_layer_0' % prefix,
                    self._replay_sample['low_dim_state_layer_0'].max()),  
                      
            ScalarSummary('%s/low_dim_state_mean_layer1' % prefix,
                    self._replay_sample['low_dim_state_layer_1'].mean()),
            ScalarSummary('%s/low_dim_state_min_layer1' % prefix,
                    self._replay_sample['low_dim_state_layer_1'].min()),
            ScalarSummary('%s/low_dim_state_max_layer_1' % prefix,
                    self._replay_sample['low_dim_state_layer_1'].max()),
